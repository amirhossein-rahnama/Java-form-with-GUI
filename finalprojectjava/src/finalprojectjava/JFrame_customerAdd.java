...
public class JFrame_customerAdd extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(
           ...
           !jTextField5.getText().trim().isEmpty()) {
            String customer_id=jTextField1.getText().trim();
            String fname=jTextField2.getText().trim();
            String lname=jTextField3.getText().trim();
            String email=jTextField4.getText().trim();
            String phone_no=jTextField5.getText().trim();

            if (!edit_customer) {
            customersystem.add_customer(customer_id, email, phone_no,fname,lname);
                JOptionPane.showMessageDialog(null, 
                        "The New customer Data is Recorded Successfully");
            } else {
            customersystem.edit_customer(customer_id, email, phone_no,fname,lname);
                JOptionPane.showMessageDialog(null, 
                        "The Selected customer Data is Edited Successfully");
            }
            customersystem.list_customer();
            setVisible(false);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        if(edit_customer){
            customer st = (customer) customersystem.customer.get(st_row);
            jTextField1.setText(st.getCustomer_id());
            jTextField2.setText(st.getFname());
            jTextField3.setText(st.getLname());
            jTextField4.setText(st.getEmail());
            jTextField5.setText(st.getPhone_no());
