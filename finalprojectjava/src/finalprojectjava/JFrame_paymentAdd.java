...
public class JFrame_paymentAdd extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(
           ...
           !jTextField3.getText().trim().isEmpty()) {
            ...
            String payment_type=jTextField2.getText().trim();
            String payment_code=jTextField3.getText().trim();

            if (!edit_payment) {
            paymentsystem.add_payment(  amount,  payment_type,  payment_code);
                JOptionPane.showMessageDialog(null, 
                        "The New payment Data is Recorded Successfully");
            } else {
            paymentsystem.edit_payment(  amount,  payment_type,  payment_code);
                JOptionPane.showMessageDialog(null, 
                        "The Selected payment Data is Edited Successfully");
            }
            paymentsystem.list_payment();
            setVisible(false);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        if(edit_payment){
            payment st = (payment) paymentsystem.payment.get(st_row);
            jTextField1.setText(st.getAmount());
            jTextField2.setText(st.getPayment_type());
            jTextField3.setText(st.getPayment_code());
